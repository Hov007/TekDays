...
%{--    </label>--}%
%{--    <g:select id="parent" name="parent.id" from="${com.tekdays.TekMessage.list()}" optionKey="id"--}%
%{--              value="${tekMessageInstance?.parent?.id}" class="many-to-one" noSelection="['null': '']"/>--}%

%{--</div>--}%
<g:hiddenField name="event" value="${params.tekEvent.id}"/>
