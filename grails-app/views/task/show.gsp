    ...
    <ol class="property-list task">
        ...
        <g:if test="${taskInstance?.title}">
            <li class="fieldcontain">
                <span id="title-label" class="property-label"><g:message code="task.title.label"
                                                                         default="Title"/></span>
        ...
        <g:if test="${taskInstance?.assignedTo}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="assignedTo-label"><g:link controller="tekUser"
                                                                                        action="show"
